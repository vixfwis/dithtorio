...
@click.option('-s', '--split', type=click.IntRange(1000, 10000000), default=65536, show_default=True, help='Blueprint size (ingame objects). Huge blueprints may slow down the game until they\'re fully loaded. 1 000 - 10 000 000')
